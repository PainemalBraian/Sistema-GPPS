...
public class InformeDeTareasController {
    ...
    private void GuardarInforme(ActionEvent event) {
        ...
        try {
            ...
            byte[] contenidoPDF = leerArchivoPDF(archivoSeleccionado.getAbsolutePath());
            api.cargarInforme(titulo, descripcion, contenidoPDF, fechaInforme);
            ...
            LOGGER.log(Level.SEVERE, "Error al leer el archivo PDF: " + archivoSeleccionado.getAbsolutePath(), e);
